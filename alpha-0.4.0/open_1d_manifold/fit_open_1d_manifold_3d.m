function fit_open_1d_manifold_3d
% 
% fit_open_1d_manifold_3d
% 
% fit the eigenvectors for an open 1D manifold to the model
...
% 
%   get_fit_open_1d_manifold_3d_param_fit_2d.m
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  get_fit_open_1d_manifold_3d_param_fit_2d
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  save(a_b_tau_result,'a','b','tau','-v7')
  
function plot_fitted_curve(hFig)
  global do_not_plot
  if ~isempty(do_not_plot), return, end
  global x x_fit
  h = figure(hFig);
  hsp = subplot(2,2,1);
